...
typedef struct record_read_vector {
  ...
  uint8_t data[HSK_DNS_MAX_NAME + 1];         // extended to fit invalid data
  size_t data_len;
  bool valid;
  uint8_t invalidname[HSK_DNS_MAX_NAME + 1];  // extended to fit invalid data
  size_t invalidname_len;
} record_read_vector_t;

typedef struct {
  uint8_t target[HSK_DNS_MAX_NAME_STRING];    // extended to fit invalid data
} hsk_dns_invalid_cname_rd_t;
...
static const record_read_vector_t record_read_vectors[] = {
  /*
   * VALID
   */
  ...
  // overly large label (64), must be broken
  {
    ...
    "",
    "\x40""1234567890123456789012345678901234567890123456789012345678901234\x07""example\x03""com\x00",
    78,
    false,
    "\x40""1234567890123456789012345678901234567890123456789012345678901234\x07""example\x03""com\x00",
    78
  ...
  {
    HSK_DNS_CNAME,
    "123456789012345678901234567890123456789012345678901234567890123.123456789012345678901234567890123456789012345678901234567890123.123456789012345678901234567890123456789012345678901234567890123.12345678901234567890123456789012345678901234567890123.rec.test.",
    "",
    "\x3f""123456789012345678901234567890123456789012345678901234567890123\x3f""123456789012345678901234567890123456789012345678901234567890123\x3f""123456789012345678901234567890123456789012345678901234567890123\x35""12345678901234567890123456789012345678901234567890123\xc0\x11",
    238,
    false,
    "\x3f""123456789012345678901234567890123456789012345678901234567890123\x3f""123456789012345678901234567890123456789012345678901234567890123\x3f""123456789012345678901234567890123456789012345678901234567890123\x35""12345678901234567890123456789012345678901234567890123\x03rec\x04test\x00",
    256
  },
  // non-local overly large name (256), must be broken
  {
    ...
    "",
    "\x3f""123456789012345678901234567890123456789012345678901234567890123\x3f""123456789012345678901234567890123456789012345678901234567890123\x3f""123456789012345678901234567890123456789012345678901234567890123\x3e""12345678901234567890123456789012345678901234567890123456789012\x00",
    256,
    false,
    "\x3f""123456789012345678901234567890123456789012345678901234567890123\x3f""123456789012345678901234567890123456789012345678901234567890123\x3f""123456789012345678901234567890123456789012345678901234567890123\x3e""12345678901234567890123456789012345678901234567890123456789012\x00",
    256
