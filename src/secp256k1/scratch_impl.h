...
#ifndef _HSK_SECP256K1_SCRATCH_IMPL_H_
#define _HSK_SECP256K1_SCRATCH_IMPL_H_
...
static hsk_secp256k1_scratch* hsk_secp256k1_scratch_create(const hsk_secp256k1_callback* error_callback, size_t init_size, size_t max_size) {
    hsk_secp256k1_scratch* ret = (hsk_secp256k1_scratch*)checked_malloc(error_callback, sizeof(*ret));
    if (ret != NULL) {
...
static size_t hsk_secp256k1_scratch_max_allocation(const hsk_secp256k1_scratch* scratch, size_t objects) {
...
static int hsk_secp256k1_scratch_resize(hsk_secp256k1_scratch* scratch, size_t n, size_t objects) {
    n += objects * ALIGNMENT;
...
static void *hsk_secp256k1_scratch_alloc(hsk_secp256k1_scratch* scratch, size_t size) {
    void *ret;
