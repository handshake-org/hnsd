...
#ifndef HSK_SECP256K1_FIELD_REPR_IMPL_H
#define HSK_SECP256K1_FIELD_REPR_IMPL_H
...
#ifdef VERIFY
static void hsk_secp256k1_fe_verify(const hsk_secp256k1_fe *a) {
...
HSK_SECP256K1_INLINE static void hsk_secp256k1_fe_set_int(hsk_secp256k1_fe *r, int a) {
    r->n[0] = a;
...
HSK_SECP256K1_INLINE static int hsk_secp256k1_fe_is_zero(const hsk_secp256k1_fe *a) {
    const uint32_t *t = a->n;
#ifdef VERIFY
    VERIFY_CHECK(a->normalized);
    hsk_secp256k1_fe_verify(a);
#endif
    return (t[0] | t[1] | t[2] | t[3] | t[4] | t[5] | t[6] | t[7] | t[8] | t[9]) == 0;
}

HSK_SECP256K1_INLINE static int hsk_secp256k1_fe_is_odd(const hsk_secp256k1_fe *a) {
#ifdef VERIFY
    VERIFY_CHECK(a->normalized);
    hsk_secp256k1_fe_verify(a);
#endif
...
HSK_SECP256K1_INLINE static void hsk_secp256k1_fe_clear(hsk_secp256k1_fe *a) {
    int i;
#ifdef VERIFY
    a->magnitude = 0;
    a->normalized = 1;
...
HSK_SECP256K1_INLINE static void hsk_secp256k1_fe_negate(hsk_secp256k1_fe *r, const hsk_secp256k1_fe *a, int m) {
#ifdef VERIFY
...
HSK_SECP256K1_INLINE static void hsk_secp256k1_fe_mul_int(hsk_secp256k1_fe *r, int a) {
    r->n[0] *= a;
    r->n[1] *= a;
    r->n[2] *= a;
    r->n[3] *= a;
...
HSK_SECP256K1_INLINE static void hsk_secp256k1_fe_add(hsk_secp256k1_fe *r, const hsk_secp256k1_fe *a) {
#ifdef VERIFY
    hsk_secp256k1_fe_verify(a);
#endif
    r->n[0] += a->n[0];
...
void hsk_secp256k1_fe_sqr_inner(uint32_t *r, const uint32_t *a);
...
HSK_SECP256K1_INLINE static void hsk_secp256k1_fe_mul_inner(uint32_t *r, const uint32_t *a, const uint32_t * HSK_SECP256K1_RESTRICT b) {
    uint64_t c, d;
...
HSK_SECP256K1_INLINE static void hsk_secp256k1_fe_sqr_inner(uint32_t *r, const uint32_t *a) {
    uint64_t c, d;
    uint64_t u0, u1, u2, u3, u4, u5, u6, u7, u8;
...
static void hsk_secp256k1_fe_mul(hsk_secp256k1_fe *r, const hsk_secp256k1_fe *a, const hsk_secp256k1_fe * HSK_SECP256K1_RESTRICT b) {
    ...
    VERIFY_CHECK(r != b);
#endif
    hsk_secp256k1_fe_mul_inner(r->n, a->n, b->n);
#ifdef VERIFY
    r->magnitude = 1;
    r->normalized = 0;
    hsk_secp256k1_fe_verify(r);
...
static void hsk_secp256k1_fe_sqr(hsk_secp256k1_fe *r, const hsk_secp256k1_fe *a) {
    ...
    hsk_secp256k1_fe_verify(a);
#endif
    hsk_secp256k1_fe_sqr_inner(r->n, a->n);
#ifdef VERIFY
    r->magnitude = 1;
    r->normalized = 0;
    hsk_secp256k1_fe_verify(r);
...
static HSK_SECP256K1_INLINE void hsk_secp256k1_fe_cmov(hsk_secp256k1_fe *r, const hsk_secp256k1_fe *a, int flag) {
...
static HSK_SECP256K1_INLINE void hsk_secp256k1_fe_storage_cmov(hsk_secp256k1_fe_storage *r, const hsk_secp256k1_fe_storage *a, int flag) {
    uint32_t mask0, mask1;
    mask0 = flag + ~((uint32_t)0);
    mask1 = ~mask0;
    r->n[0] = (r->n[0] & mask0) | (a->n[0] & mask1);
...
static HSK_SECP256K1_INLINE void hsk_secp256k1_fe_from_storage(hsk_secp256k1_fe *r, const hsk_secp256k1_fe_storage *a) {
...
#endif /* HSK_SECP256K1_FIELD_REPR_IMPL_H */
